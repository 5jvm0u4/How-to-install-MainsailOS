...
After finishing "First boot" section, move to [How to flash klipper to BigTreeTech Octopus V1.0](https://github.com/5jvm0u4/How-to-flash-klipper-firmware-on-BigTreeTech-Octopus/tree/main) for further instructions.
